...
<body>
    <header class="header" style="background-color: rgb(92, 51, 240); align-items: center;">
        <h1 style="color: white; text-align: center;">Pendaftaran</h1>
        <nav class="navbar">
            <ul style="list-style-type: none; text-decoration: none; display: flex;">
                ...
                <li><a href="{{ url('/login') }}" style="color: white; text-decoration: none; margin: 5px; font-family: sans-serif;">Login</a></li>
            </ul>
        </nav>
    </header>
<div class="container">
